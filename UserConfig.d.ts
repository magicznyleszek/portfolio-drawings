...
declare class UserConfig {
    ...
    watchTargetsConfigReset: Set<any>;
    ...
    once(eventName: any, callback: any): any;
    emit(eventName: any, ...args: any[]): any;
    setEventEmitterMode(mode: any): void;
    ...
    addWatchTarget(additionalWatchTargets: any, options?: {}): void;
    ...
    _attemptedBrowserSyncUse: boolean;
    ...
    configureErrorReporting(options?: {}): void;
    getCollections(): any;
    addCollection(name: any, callback: any): void;
    augmentFunctionContext(fn: any, options: any): any;
